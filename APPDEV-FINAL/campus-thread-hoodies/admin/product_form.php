...
$imageOptions = [
    'assets/img/hoodie-maroon.svg',
    'assets/img/hoodie-forest.svg',
    'assets/img/hoodie-navy.svg',
    'assets/img/hoodie-ash.svg',
    'assets/img/hoodie-cream.svg',
    'assets/img/hoodie-teal.svg',
];
    ...
    <div class="form-panel">
        ...
        <form method="post" class="stacked-form">
            ...
            <div class="form-grid">
                ...
                <label>Size
                    <input type="text" name="size" value="<?= h($productRecord['size']) ?>" required>
                </label>
            </div>
            <div class="form-grid">
                <label>Price
